...
@Component({
  selector: 'app-cancellation-policy-tab-view',
  standalone: true,
  ...
  templateUrl: './cancellation-policy-tab-view.component.html',
  styleUrl: './cancellation-policy-tab-view.component.scss'
})
export class CancellationPolicyTabViewComponent implements OnInit {

  //cancellationPolicyCreateForm!: FormGroup;
  currencyList = [];
