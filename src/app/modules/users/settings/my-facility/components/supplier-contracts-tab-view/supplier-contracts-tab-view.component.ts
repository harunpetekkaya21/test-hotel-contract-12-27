...
@Component({
  selector: 'app-supplier-contracts-tab-view',
  standalone: true,
  imports: [InputSwitchModule, MultiSelectModule, FieldsetModule, FormsModule, ReactiveFormsModule, CheckboxModule, CommonModule, DropdownModule, CalendarModule, InputNumberModule, InputTextModule, RadioButtonModule, TableModule, InputTextareaModule],
  templateUrl: './supplier-contracts-tab-view.component.html',
  styleUrl: './supplier-contracts-tab-view.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SupplierContractsTabViewComponent implements OnInit {
