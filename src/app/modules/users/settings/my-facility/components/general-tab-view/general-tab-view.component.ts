...
@Component({
  selector: 'app-general-tab-view',
  standalone: true,
  imports: [CommonModule, DialogModule, FieldsetModule, ButtonModule, InputTextareaModule, InputNumberModule, InputTextModule, CheckboxModule, DropdownModule, MessageModule, ReactiveFormsModule, FormsModule],
  templateUrl: './general-tab-view.component.html',
  styleUrl: './general-tab-view.component.scss'
})
export class GeneralTabViewComponent implements OnInit {
